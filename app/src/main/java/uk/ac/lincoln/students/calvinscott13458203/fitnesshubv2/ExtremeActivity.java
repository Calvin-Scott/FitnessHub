...
public class ExtremeActivity extends AppCompatActivity
    ...
    ArrayList<String> yogaData = new ArrayList<>();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(ExtremeActivity.this, "Coming Soon", Toast.LENGTH_SHORT).show();
    ...
    public class AsyncTaskParseJson extends AsyncTask<String, String, String>
    {
        ...
        String UrltoPass = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&q=Extreme+Workout&key=AIzaSyAWUakR7R2T7NY8O43gh03AsCaDjDxG-ZM";
        @Override
            ...
            try {
                ...
                for (int i = 0; i < items.length(); i++) {
                    ...
                    if (snippet != null) {
                        ...
                        yogaData.add(snippet.getString("title"));
                    }
                }
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> yogaArrayAdapter = new ArrayAdapter<>(ExtremeActivity.this, android.R.layout.simple_expandable_list_item_1, yogaData);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(ExtremeActivity.this, userPick, Toast.LENGTH_SHORT).show();

                    Intent videoPlayer = new Intent(ExtremeActivity.this,VideoWebActivity.class);
