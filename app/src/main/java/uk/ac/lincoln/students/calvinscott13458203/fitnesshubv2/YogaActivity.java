...
public class YogaActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(YogaActivity.this, "Coming Soon", Toast.LENGTH_SHORT).show();
    ...
    public class AsyncTaskParseJson extends AsyncTask<String, String, String>
    {
        ...
        String UrltoPass = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&q=Yoga+Workout&key=AIzaSyAWUakR7R2T7NY8O43gh03AsCaDjDxG-ZM";
        @Override
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> yogaArrayAdapter = new ArrayAdapter<>(YogaActivity.this, android.R.layout.simple_expandable_list_item_1, yogaData);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(YogaActivity.this, userPick, Toast.LENGTH_SHORT).show();

                    Intent videoPlayer = new Intent(YogaActivity.this,VideoWebActivity.class);
