...
public class CardioActivity extends AppCompatActivity
    ...
    ArrayList<String> cardioData = new ArrayList<>();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(CardioActivity.this, "Coming Soon", Toast.LENGTH_SHORT).show();
    ...
    public class AsyncTaskParseJson extends AsyncTask<String, String, String>
    {
        ...
        String UrltoPass = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&q=Cardio+Workout&key=AIzaSyAWUakR7R2T7NY8O43gh03AsCaDjDxG-ZM";
        @Override
            ...
            try {
                ...
                for (int i = 0; i < items.length(); i++) {
                    ...
                    if (snippet != null) {
                        ...
                        cardioData.add(snippet.getString("title"));
                    }
                }
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> yogaArrayAdapter = new ArrayAdapter<>(CardioActivity.this, android.R.layout.simple_expandable_list_item_1, cardioData);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(CardioActivity.this, userPick, Toast.LENGTH_SHORT).show();

                    Intent videoPlayer = new Intent(CardioActivity.this,VideoWebActivity.class);
