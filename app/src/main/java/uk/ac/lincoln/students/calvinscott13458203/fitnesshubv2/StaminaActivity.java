...
public class StaminaActivity extends AppCompatActivity
        implements NavigationView.OnNavigationItemSelectedListener {

    ArrayList<String> staminaData = new ArrayList<>();
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_home) {
            ...
            Toast.makeText(StaminaActivity.this, "Coming Soon", Toast.LENGTH_SHORT).show();
    ...
    public class AsyncTaskParseJson extends AsyncTask<String, String, String>
    {
        ...
        String UrltoPass = "https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=15&q=Stamina+Workout&key=AIzaSyAWUakR7R2T7NY8O43gh03AsCaDjDxG-ZM";
        @Override
            ...
            try {
                ...
                for (int i = 0; i < items.length(); i++) {
                    ...
                    if (snippet != null) {
                        ...
                        staminaData.add(snippet.getString("title"));
                    }
                }
        ...
        protected void onPostExecute(String s) {
            ...
            ArrayAdapter<String> yogaArrayAdapter = new ArrayAdapter<>(StaminaActivity.this, android.R.layout.simple_expandable_list_item_1, staminaData);
            ...
            list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                    ...
                    Toast.makeText(StaminaActivity.this, userPick, Toast.LENGTH_SHORT).show();

                    Intent videoPlayer = new Intent(StaminaActivity.this,VideoWebActivity.class);
